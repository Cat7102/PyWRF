...
west_lon, east_lon      = 120.6, 122.0  # 图片显示范围，西侧和东侧经度
south_lat, north_lat    = 30.6, 31.8    # 图片显示范围，南侧和北侧纬度
...
rect1, rect2, rect3, rect4  = 0.8, 0.1, 0.01, 0.8    # colorbar的位置,分别是 水平位置，垂直位置，水平宽度，垂直宽度
