...
if __name__ == '__main__':
    for i in range(1,8,1):
        filename="118038_b"+str(i)+".tif"
        outputname="resize_118038_b"+str(i)+".tif"
        resize_tiff(os.path.join(r"D:\Data\WRF-Chem_Files\LandUse_LandCover_Data\LCZ_Shanghai_2021\Landsat8\2_Prepare\6_atmos_corr\multiband_tiff",filename),
                    os.path.join(r"D:\Data\WRF-Chem_Files\LandUse_LandCover_Data\LCZ_Shanghai_2021\Landsat8\2_Prepare\7_resize2",outputname),
                    gdal.GDT_Float32)
    for i in range(1,8,1):
        filename="118039_b"+str(i)+".tif"
        outputname="resize_118039_b"+str(i)+".tif"
        resize_tiff(os.path.join(r"D:\Data\WRF-Chem_Files\LandUse_LandCover_Data\LCZ_Shanghai_2021\Landsat8\2_Prepare\6_atmos_corr\multiband_tiff",filename),
                    os.path.join(r"D:\Data\WRF-Chem_Files\LandUse_LandCover_Data\LCZ_Shanghai_2021\Landsat8\2_Prepare\7_resize2",outputname),
                    gdal.GDT_Float32)
    for i in range(1,8,1):
        filename="119038_b"+str(i)+".tif"
        outputname="resize_119038_b"+str(i)+".tif"
        resize_tiff(os.path.join(r"D:\Data\WRF-Chem_Files\LandUse_LandCover_Data\LCZ_Shanghai_2021\Landsat8\2_Prepare\6_atmos_corr\multiband_tiff",filename),
                    os.path.join(r"D:\Data\WRF-Chem_Files\LandUse_LandCover_Data\LCZ_Shanghai_2021\Landsat8\2_Prepare\7_resize2",outputname),
                    gdal.GDT_Float32)