...
class Figure4wrf():
    ...
    def geo_draw(self, lake_opt, lake_lw, lake_lc, river_opt, river_lw, river_lc, coastline_lw, coastline_lc, precision):
        # 添加海岸线数据
        self.axe.add_feature(cfeat.COASTLINE.with_scale(precision), linewidth=coastline_lw,
                             color=coastline_lc, zorder=1)
        # cartopy使用的地理信息网站：https://www.naturalearthdata.com/features/
